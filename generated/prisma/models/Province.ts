...
export type ProvinceWhereInput = {
  ...
  prov_id?: Prisma.StringFilter<"Province"> | string
  prov_name?: Prisma.StringFilter<"Province"> | string
...
export type ProvinceScalarWhereWithAggregatesInput = {
  ...
  prov_id?: Prisma.StringWithAggregatesFilter<"Province"> | string
  prov_name?: Prisma.StringWithAggregatesFilter<"Province"> | string
...
export type ProvinceUpdateInput = {
  ...
  prov_name?: Prisma.StringFieldUpdateOperationsInput | string
...
export type ProvinceOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"prov_id" | "prov_name" | "createdAt" | "updatedAt", ExtArgs["result"]["province"]>
...
export interface ProvinceDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `prov_id`
   * const provinceWithProv_idOnly = await prisma.province.findMany({ select: { prov_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Provinces and only return the `prov_id`
   * const provinceWithProv_idOnly = await prisma.province.createManyAndReturn({
   *   select: { prov_id: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Provinces and only return the `prov_id`
   * const provinceWithProv_idOnly = await prisma.province.updateManyAndReturn({
   *   select: { prov_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ProvinceFieldRefs {
  readonly prov_id: Prisma.FieldRef<"Province", 'String'>
  readonly prov_name: Prisma.FieldRef<"Province", 'String'>
